...
restart=createSprite(width/2,resume.y-50,200,200) 
...
var   CA=frameCount%500===0
var CB=frameCount%250===0
...
coin1.lifetime=0
  ...
  fill("blue")
  textSize(18)
  text("eyery 1000 meter you get 3Coin",width-width+5,height-height+30) 
 text("eyery 10000 meter you get 50Coin",width-width+5,height-height+50) 
...
if (hi===0){
coin2.visible=true
 text(totalcoin,width/2,coin2.y+5) 
 }
 textSize(24)
if (hi===1){
coin2.visible=true
text(totalcoin,width/2,coin2.y+5) 
text("NewHiScore["+LocalStorage+"]",width/2-85,coin2.y-25)
}   
   if (mousePressedOver(resume)&&totalcoin>7){ 
DT=0
hi=0
gamestate=play
restart.visible=false
resume.visible=false
      ...
      coin1.lifetime=0
      coine=0
      totalcoin=totalcoin-8 
   }
   if (touches.length>width/2&&totalcoin>7){ 
DT=0
hi=0
gamestate=play
restart.visible=false
